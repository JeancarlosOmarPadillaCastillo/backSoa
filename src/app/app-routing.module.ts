...
import {ActivitiesFormComponent} from "./components/activities/activities-form/activities-form.component";
import {
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: "activities-form", canActivate: [permissionsGuard], component: ActivitiesFormComponent },
      { path: "historial", canActivate: [permissionsGuard], component: HistorialPrincipalComponent},
      { path: "asignationActTeen-list", component: AsignationActTeenPrincipalComponent },
      { path: "asignationActTeen-form", component: AsignationActTeenFormComponent }
    ]
  },
];
